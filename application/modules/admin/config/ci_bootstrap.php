...
$config['ci_bootstrap'] = array(
    ...
    'page_auth' => array(
       ...
       // 'util' => array('webmaster', 'admin'),
		...
		'work_list' => array('webmaster', 'admin'),
		'work_list/create' => array('webmaster', 'admin'),
		
		'report/now' => array('webmaster', 'admin'),
		'report/late' => array('webmaster', 'admin'),
		'report/problem' => array('webmaster', 'admin'),
		'report/success' => array('webmaster', 'admin'),
		'formula' => array('webmaster', 'admin'),
		'formula/create' => array('webmaster', 'admin'),
		'materials' => array('webmaster', 'admin'),
		'materials/create' => array('webmaster', 'admin'),
    ),
    // AdminLTE settings
    'adminlte' => array(
        'body_class' => array(
