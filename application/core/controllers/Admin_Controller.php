...
class Admin_Controller extends MY_Controller {
	...
	public $keyadmin=NULL;
	public $keywebmaster=NULL;
	public $keystaff=NULL;
    ...
    public function __construct() {
		...
		$this->keystaff = array_search(4,$this->session->userdata('group_us'));
		
		$this->keymanager = array_search(3,$this->session->userdata('group_us'));
		
		$this->keyadmin = array_search(2,$this->session->userdata('group_us'));
		
		$this->keywebmaster = array_search(1,$this->session->userdata('group_us'));
